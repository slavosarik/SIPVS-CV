...
public class FormView {
	...
	private void createFields() {
		...
		course1.add(new TextNode(parentNode, "organization", "Organization", "Tunelárska elektrika, spol. s r.o.",
				false, true));
		...
		experience.add(new TextNode(parentNode, "employer", "Employer",
				"Fakulta Informatiky a Informačných technológií", false, true));
		...
		project.add(
				new TextNode(parentNode, "description", "Description", "curl XGET http://fiit.stuba.sk", false, true));
